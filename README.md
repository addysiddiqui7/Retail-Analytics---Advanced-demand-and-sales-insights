...
•	Cancellation filtering: redundant for elasticity, beyond scope of this project, thus negative Quantity and Price values are dropped, thus indicating the return and losses.
...
o	REGENCY CAKESTAND 3 TIER — Rank #1 revenue (£344,563)
o	Manual, DOTCOM POSTAGE, WHITE HANGING HEART T-LIGHT HOLDER follow
...
o	e.g., PAPER CRAFT, LITTLE BIRDIE — 80,995 units in Dec 2011 (highest single-month quantity)
o	MEDIUM CERAMIC TOP STORAGE JAR — 74,215 units in Jan 2011
...
2. Upload notebooks to Databricks Import the .ipynb files into your Databricks workspace under a project folder.
